...
import { Home , Splash, Akun,Transaksi,Pesanan,AkhirForm,
	Order,History,Tambah,AkhirAkun } from '../pages';
...
const Router = () => {
	return (
		<Stack.Navigator initialRouteName="Splash">
			...
			<Stack.Screen name="AkhirAkun" component={AkhirAkun} options= {{ headerShown: false}}/>
